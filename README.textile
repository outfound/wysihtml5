...
* 0.4.0pre: Fixed undo when the last element is not editable (signature)
* 0.4.1pre: Fixed fatal bug with Firefox when wysiwyg is not visible at time of creation
